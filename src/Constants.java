public class Constants {
    ...
    public static final String PIZZA_CHEESE_TOPPINGS = "Cheese";
    public static final String PIZZA_MUSHROOM_TOPPINGS = "Mushroom";
    public static final String PIZZA_TOMATO_TOPPINGS = "Tomato";
    ...
    public static final String PASTA_PENNE_TYPE = "Penne";
    public static final String PASTA_DITALINI_TYPE = "Ditalini";

    public static final String PIZZA_LARGE_SIZE = "Large";
    public static final String PIZZA_SMALL_SIZE = "Small";
    public static final String PIZZA_MEDIUM_SIZE = "Medium";
